...
<div class="wrapper no-navigation preload">
    <div class="sign-in-wrapper">
       ...
       placeholder="{$_L['Email Address']}" required>
                ...
                {if isset($otp_required) && $otp_required === true}
                <div class="form-group">
                    <input type="text" class="form-control" id="otp" name="otp" placeholder="{$_L['Enter OTP']}" required>
                </div>
                <div class="m-top-md p-top-sm">
                    <button class="btn btn-primary block full-width" name="verify_otp" type="submit">{$_L['Verify OTP']}</button>
                </div>
                {/if}
